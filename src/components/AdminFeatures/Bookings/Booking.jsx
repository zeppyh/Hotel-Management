      ...
      <div className="booking-container">
        <div className="booking-content">
                    ...
                    {loading ? (
                      ...
                      <TableRow>
                        <TableCell colSpan={8} align="center">
                          {searchTerm || status !== "All Status" 
                            ? `No bookings found matching criteria "${searchTerm || status}".`
                      ...
                      displayedBookings.map((row) => (
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <StatusBadge bookId={row.bookId} status={row.status} />
                          </TableCell>
          ...
          {filteredBookings.length > ITEMS_PER_PAGE && (
            <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '15px', paddingRight: '20px' }}>
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '25px 40px' }}>
              ...
              <div>
                  <h3 style={{ color: '#4A5A47', fontSize: '18px', fontWeight: 600, marginBottom: '15px' }}>
                    Guest & Contact
                  </h3>
                  
                  <div style={{ paddingRight: '15px', borderRight: '1px solid #E5D8C5' }}>
                      <p style={{ margin: '8px 0', fontSize: '15px' }}>
                          <strong style={{ display: 'inline-block', width: '80px', color: '#8B7355' }}>Name:</strong> 
                          {selectedBookingDetails.guestName}
                      </p>
                      <p style={{ margin: '8px 0', fontSize: '15px' }}>
                          <strong style={{ display: 'inline-block', width: '80px', color: '#8B7355' }}>Email:</strong> 
                          {selectedBookingDetails.guestEmail}
                      </p>
                      <p style={{ margin: '8px 0', fontSize: '15px' }}>
                          <strong style={{ display: 'inline-block', width: '80px', color: '#8B7355' }}>Contact:</strong> 
                          {selectedBookingDetails.contactNumber || 'N/A'}
                      </p>
                      <p style={{ margin: '15px 0 0 0', fontSize: '15px' }}>
                          <strong style={{ display: 'inline-block', color: '#8B7355' }}>Status:</strong> 
                          <StatusBadge bookId={selectedBookingDetails.bookId} status={selectedBookingDetails.status} />
                      </p>
                  </div>
              </div>
              ...
              <div>
                  ...
                  <p style={{ margin: '8px 0', fontSize: '15px' }}>
                      <strong style={{ display: 'inline-block', width: '100px', color: '#8B7355' }}>Room Type:</strong> 
                      {selectedBookingDetails.roomType}
                  </p>
                  <p style={{ margin: '8px 0', fontSize: '15px' }}>
                      <strong style={{ display: 'inline-block', width: '100px', color: '#8B7355' }}>Check-in:</strong> 
                      {selectedBookingDetails.checkIn}
                  </p>
                  <p style={{ margin: '8px 0', fontSize: '15px' }}>
                      <strong style={{ display: 'inline-block', width: '100px', color: '#8B7355' }}>Check-out:</strong> 
                      {selectedBookingDetails.checkOut}
                  </p>
                  <p style={{ margin: '8px 0', fontSize: '15px' }}>
                      <strong style={{ display: 'inline-block', width: '100px', color: '#8B7355' }}>Payment:</strong> 
                      {selectedBookingDetails.paymentMethod || 'N/A'}
                  </p>
                  <p style={{ margin: '8px 0', fontSize: '15px' }}>
                      <strong style={{ display: 'inline-block', width: '100px', color: '#B46F46' }}>Amount Paid:</strong> 
                      <span style={{ fontWeight: 'bold', color: '#B46F46' }}>₱{selectedBookingDetails.amount}</span>
                  </p>
              </div>
            </div>
            
            
            {(selectedBookingDetails.specialRequest && selectedBookingDetails.specialRequest.trim() !== "") && (
              <div style={{ marginTop: '30px', paddingTop: '20px', borderTop: '1px solid #E5D8C5' }}>
                <h3 style={{ color: '#4A5A47', fontSize: '18px', fontWeight: 600, marginBottom: '10px' }}>
                  Special Requests
                </h3>
                <p style={{ backgroundColor: '#F7F4EC', padding: '15px', borderRadius: '10px', lineHeight: 1.5, color: '#444' }}>
      ...
      {isEditModalOpen && editedBookingData && (
        ...
        >
          ...
          >
            ...
            <h1 style={{ color: '#8B7355', fontSize: '28px', fontWeight: 800, marginBottom: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px 40px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                  <h3 style={{ color: '#4A5A47', fontSize: '18px', fontWeight: 600 }}>Guest Information</h3>

                  <label style={{ display: 'block', fontSize: '14px', color: '#8B7355' }}>Full Name</label>
                  <input
                    type="text"
                    name="guestName"
                    value={editedBookingData.guestName || ''}
                    onChange={handleEditChange}
                    style={{ padding: '10px', border: '1px solid #E5D8C5', borderRadius: '8px' }}
                  />

                  <label style={{ display: 'block', fontSize: '14px', color: '#8B7355' }}>Email</label>
                  <input
                    type="email"
                    name="guestEmail"
                  ...
                  <label style={{ display: 'block', fontSize: '14px', color: '#8B7355' }}>Contact Number</label>
                  <input
                    type="tel"
                    name="contactNumber"
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                  <h3 style={{ color: '#4A5A47', fontSize: '18px', fontWeight: 600 }}>Booking Details</h3>
                  
                  <label style={{ display: 'block', fontSize: '14px', color: '#8B7355' }}>Check-in Date</label>
                  <input
                    type="date"
                    name="checkIn"
                  ...
                  <label style={{ display: 'block', fontSize: '14px', color: '#8B7355' }}>Check-out Date</label>
                  <input
                    type="date"
                    name="checkOut"
                  ...
                  <label style={{ display: 'block', fontSize: '14px', color: '#8B7355' }}>Room Type</label>
                  ...
                  <select
                    ...
                    style={{ padding: '10px', border: '1px solid #E5D8C5', borderRadius: '8px' }}
                  >
                    {ROOM_TYPES.map(s => <option key={s} value={s}>{s}</option>)}
                  </select>
                  
                  <label style={{ display: 'block', fontSize: '14px', color: '#8B7355' }}>Status</label>
                  <select
                    name="status"
                  ...
                  <p style={{ margin: '15px 0 0 0', fontSize: '15px', color: '#B46F46' }}>
                      <strong style={{ fontWeight: 'bold' }}>New Total Amount:</strong> 
                      <span style={{ fontWeight: 'bold', marginLeft: '10px' }}>₱{editedBookingData.amount}</span>
                  </p>
              </div>
            </div>
            ...
            <div style={{ marginTop: '30px' }}>
                <h3 style={{ color: '#4A5A47', fontSize: '18px', fontWeight: 600, marginBottom: '10px' }}>Special Request</h3>
                <textarea
                    name="guestRequest"
                    rows="4"
                    value={editedBookingData.guestRequest || ''}
                    onChange={handleEditChange}
                    style={{ width: '100%', padding: '15px', border: '1px solid #E5D8C5', borderRadius: '10px', resize: 'none' }}
                />
            </div>
